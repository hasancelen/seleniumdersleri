...
public class c25_seleniyumwait {
    ...
    Dinamik degil statiktir.
            implicitlyWait : Selenium’dan gel ir. Sayfanin yuklenmesi ve herbir webElementin locate edilmesi
    ...
    Genellikle wait.until() method’u locate ile b
